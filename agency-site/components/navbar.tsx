...
export function Navbar() {
  ...
  return <header className="sticky top-0 z-50 border-b border-slate-200/70 bg-[#f8fbff]/85 backdrop-blur-xl">
    ...
    {open && <div id="mobile-menu" className="fixed inset-x-0 top-[76px] h-[calc(100vh-76px)] border-t border-slate-200 bg-[#f8fbff] px-5 py-8 lg:hidden">
